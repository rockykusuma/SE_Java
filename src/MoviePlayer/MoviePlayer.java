...
public class MoviePlayer extends Application  {
    ...
    public static String arg1 = "file:///D:/Partition2/Music/Videos/video1.mp4";
    ...
    public void start(final Stage stage) throws Exception {
       ...
       // String trailer = getHostServices().getDocumentBase()+"Images/3.mp4";
       // Media media = new Media(trailer);
        Media media = new Media(arg1);
