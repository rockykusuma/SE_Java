...
$forum = "forum.php?id=".$id."&video_name=".$video."&number=".$x;
...
<html lang="en">
          ...
          <div class="navbar-inner">
            <div class="container">
              <ul class="nav">
                ...
                <li  class="active" ><a href="wheel.htm">Watch Videos</a></li>
  ...
  <div>
    ...
    <div class="well">
            ...
            <?php
             echo "<source src='videos/".$id."/".$video.".mp4' type='video/mp4'>";
...
<a href="<?php echo $forum; ?>"> Click here for the fourm for this video </a>
<p> DescriptionDescriptionDescriptionDescriptionDescriptionDescriptionDescriptionDescriptionDescriptionDescriptionDescriptionDescription
DescriptionDescriptionDescriptionDescriptionDescriptionDescriptionDescriptionDescriptionDescriptionDescription</p>
